   ...
   <nav class="navbar navbar-default site-header" role="navigation">
        ...
        <div class="container-fluid">
            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                ...
                <a class="navbar-brand" style = "color: #003f72;" href="#"><? if (isset($title)) echo $title; else echo __($this->fetch('title')); ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="/profile" class = 'head-link'>Управление профилями</a></li>
