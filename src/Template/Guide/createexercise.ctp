...
<form method="POST" action="<?= isset($edit)?'editexercise':'createexercise'?>" enctype='multipart/form-data'>
...
<div class="formelement">
            ...
            echo "<option value=". $musculgroup->id . " " . ((isset($exercise) && $exercise->musculgroups[0]->id == $musculgroup->id)?"selected":"") . ">" . $musculgroup->name . "</option>";
            }?>
