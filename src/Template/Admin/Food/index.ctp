...
<div class="row">
  ...
  <!-- 1 панель -->
              ...
              <div id="collapse<?= $id ?>" class="panel-collapse collapse <?if ($id==0) echo("in");?>" <?if ($id==0) echo("aria-expanded = true"); else echo("aria-expanded = false");?>>
                ...
                <div class="item <?= $j==count($foodcategorie->foods)?"last":""?> title="">
                  <div class="wraper drugel" id="<?= $food->id ?>" onclick="show(<?= $food->id ?>);">
                    ...
                    <div class="form">
        <div class="row">
          <a href="/admin/food/edit/<?= $food->id?>"><div class="btn"><span class="glyphicon glyphicon-pencil"></span></div></a>
          <a href="/admin/food/delete/<?= $food->id?>"><div class="btn"><span class="glyphicon glyphicon-trash"></span></div></a>
        </div>
      </div>
                  </div>
                </div>
      ...
      <input type="button" class="btn-11" onclick="document.location = '/admin/food/create'" value ="Добавить">
    </div>
      </div>
    </div>
		<div class="col-lg-8 ">
...
<script type="text/javascript">
  ...
  var data = "<div class='foodcontent'> <h2>" + productdesc[id].name + "</h2><hr><p><b>Белки: </b>" + productdesc[id].hidrocarbonats + "</p><p><b>Жиры: </b>" + productdesc[id].fats + "</p><p><b>Углеводы: </b>" + productdesc[id].proteins + "</p><p><b>Калории: </b>" + productdesc[id].colories + "</p></div>";
