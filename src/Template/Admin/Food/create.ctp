...
<div class = "col-xs-6">
    ...
    <form method="POST" action="<?= isset($edit)?('/admin/food/edit/' . $food->id):'/admin/food/create'?>" enctype='multipart/form-data'>
    ...
    <div id="step1content">
        <div id="content" class="row box content">
            ...
            <div class="formelement">
                ...
                <select id="foodcategory" type="text" name="foodcategory" required class="form-control" value="<?= isset($food)?$food->foodcategory->id:1 ?>">
                    <? foreach($foodcategories as $foodcategory) {
                        echo "<option value=". $foodcategory->id . ((isset($food) && $food->foodcategory->id == $foodcategory->id)?"selected":"") . ">" . $foodcategory->name . "</option>";
                    }?>
                </select>
            </div>
