...
<div class="row">
      ...
      <div id="content" class="row box content contentleft item">
        <div class="header">
        <h2 id=<?= $musculgroup->id ?>><?= $musculgroup->name ?></h2>
      </div>
        
        <div class="form">
        <div class="row">
          <div class="btn" onclick="edit(<?= $musculgroup->id ?>, '<?= $musculgroup->name ?>');"><span class="glyphicon glyphicon-pencil"></span></div>
          <a href="/admin/musculgroup/delete/<?= $musculgroup->id?>"><div class="btn"><span class="glyphicon glyphicon-trash"></span></div></a>
        </div>
      </div>
      </div>
      <? } 
...
<div id="myModalBox" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="/admin/musculgroup/create">
      <div class="modal-body">
        
            <label>Название группы мышц</label>
...
<div id="myModalBox1" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title">Изменение группы мышц</h4>
      </div>
      <!-- Основное содержимое модального окна -->
      <form method="POST" action="/admin/musculgroup/edit">
      <div class="modal-body">
